...
<div class="djangui-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'amount',
            [ 
                'label' => $model->getAttributeLabel('penalty_type'),
                'value' => $model->penalty_type == 1 ? Yii::t('app', 'Fix Amount') : Yii::t('app', 'Percentage')
            ],
            'penalty_amount',
            [ 
                'label' => $model->getAttributeLabel('penalty_account'),
                'value' => ($model->penalty_account == 0) ? "" : BankAccount::findOne($model->penalty_account)->name,
            ],
            [ 
