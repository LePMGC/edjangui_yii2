...
class BankAccountController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $model->cash_in_allowed = true;
        $model->cash_out_allowed = true;
        $model->loan_allowed = true;
        $model->fix_cash_in_amount = 0;
        $model->min_balance_for_loan = 0;
        $model->min_cash_in_amount = 0;
