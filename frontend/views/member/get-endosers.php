            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <h5> Amount Requested : <b> <?= Yii::$app->formatter->asDecimal($loan_amount) ?> </b> <br/> Required Endorse Amount : <b> <?= Yii::$app->formatter->asDecimal($required_endorse_amount) ?> </b> </h5>
                        <?php
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <?php $form = ActiveForm::begin(['id' => 'reset-password-form']); ?>
                            ...
                            <table class="table table-striped" style="font-size:13px" id="myTable">
                                <tr>
                                    <th width="1%"></th>
                                    <th width="39%">Member</th>
                                    <th width="30%" class="hidden-xs hidden-sm">Available</th>
                                    ...
                                    foreach ($endorsersData as $endorsersDataItem) {
                                        ...
                                        echo "<tr> <td colspan='4' class='hiddenRow'>
                                            <div id='demo".$i."' class='accordian-body collapse'>".
                                                    '<span> <b>'.
                                                        'Bank: '.'</b>'. Yii::$app->formatter->asDecimal($endorsersDataItem['bank_solde']).
                                                    '</span> <br/>'.
                                                '<span> <b>'.
                                                        'Endorsed: '.'</b>'.Yii::$app->formatter->asDecimal($endorsersDataItem['current_amount_endorsed']).
                                                '</span> <br/>'.
                                                '<span> <b>'.
                                                        'Available: '.'</b>'.Yii::$app->formatter->asDecimal($amountAvailableForEndorse).
                                                '</span>'.
                                            "</div>
                                        </td></tr>";
                ...
                <div class="panel-footer">
                    <div class="form-group" >
                        <?= Html::a(Yii::t('app', '< Loan Request'), Url::to(['/member/ask-a-loan']), ['class' => 'btn btn-success']); ?>
